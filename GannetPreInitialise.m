...
% Analysis Parameters
    ...
    MRS_struct.p.AlignTo = 'SpecRegHERMES'; % options are 'SpecReg' (recommended for MEGA-PRESS), 'SpecRegHERMES' (recommended for HERMES and GSH-edited MEGA-PRESS), 'Cr', 'Cho', 'NAA', 'H2O' or 'CrOFF'
