...
% Analysis Parameters
    ...
    MRS_struct.p.water_removal = 1; % remove residual water in HERMES data using HSVD -- GO and MGSaleh 2016
    ...
    MRS_struct.p.Vox = {'vox1','vox2'}; % for naming voxels acquired by PRIAM, e.g: anterior and posterior, right and left, etc. -- MGSaleh 2016
