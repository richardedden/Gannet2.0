...
for jj = 1:nframes
    initxLSQ = lsqcurvefit(@TwoLorentzModel, initx, freq', real(FrameData(:,jj)),[],[],lsqopts);    
    [FitParams(jj,:), residCr] = nlinfit(freq', real(FrameData(:,jj)), @TwoLorentzModel, initxLSQ, nlinopts);
