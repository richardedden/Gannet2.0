...
matlabbatch{1}.spm.tools.preproc8.tissue(5).tpm = {[spmhome '/toolbox/Seg/TPM.nii,5']};
...
matlabbatch{1}.spm.tools.preproc8.tissue(6).tpm = {[spmhome '/toolbox/Seg/TPM.nii,6']};
