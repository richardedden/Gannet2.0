...
%Ultimately this switch will not be necessary...
    ...
    h=figure(103);
        ...
        text(.5,0.51, tmp, 'HorizontalAlignment','right',...
            'VerticalAlignment', 'top',...
            'FontName', 'Helvetica','FontSize',12);
        tmp = [': [' num2str(MRS_struct.p.voxsize(ii,1)) ', ' num2str(MRS_struct.p.voxsize(ii,2)) ', ' num2str(MRS_struct.p.voxsize(ii,3)) '] mm'  ];        text(.5, 0.55, tmp, ...
            'VerticalAlignment', 'top',...
            'FontName', 'Helvetica','FontSize',12);
        ...
        text(0.5,0.13, tmp, 'HorizontalAlignment','right',...
            'VerticalAlignment', 'top',...
            'FontName', 'Helvetica','FontSize',12);
        tmp = ': 140707';
        text(.5, 0.13, tmp, ...
