function CallSPM8segmentation(anatimage)
...
matlabbatch{1}.spm.spatial.preproc.opts.tpm = {fullfile(spmhome,'tpm','grey.nii')
                                               fullfile(spmhome,'tpm','white.nii')
                                               fullfile(spmhome,'tpm','csf.nii')};
...
matlabbatch{2}.spm.tools.preproc8.tissue(1).tpm = {fullfile(spmhome,'toolbox','Seg','TPM.nii,1')};
...
matlabbatch{2}.spm.tools.preproc8.tissue(2).tpm = {fullfile(spmhome,'toolbox','Seg','TPM.nii,2')};
...
matlabbatch{2}.spm.tools.preproc8.tissue(3).tpm = {fullfile(spmhome,'toolbox','Seg','TPM.nii,3')};
...
matlabbatch{2}.spm.tools.preproc8.tissue(4).tpm = {fullfile(spmhome,'toolbox','Seg','TPM.nii,4')};
...
matlabbatch{2}.spm.tools.preproc8.tissue(5).tpm = {fullfile(spmhome,'toolbox','Seg','TPM.nii,5')};
...
matlabbatch{2}.spm.tools.preproc8.tissue(6).tpm = {fullfile(spmhome,'toolbox','Seg','TPM.nii,6')};
