...
tpm = cellstr(spm_select('ExtFPList',fullfile(spmhome,'toolbox','Seg'),'TPM.nii'));
...
matlabbatch{2}.spm.tools.preproc8.tissue(1).tpm = tpm(1);
...
matlabbatch{2}.spm.tools.preproc8.tissue(2).tpm = tpm(2);
...
matlabbatch{2}.spm.tools.preproc8.tissue(3).tpm = tpm(3);
...
matlabbatch{2}.spm.tools.preproc8.tissue(4).tpm = tpm(4);
...
matlabbatch{2}.spm.tools.preproc8.tissue(5).tpm = tpm(5);
...
matlabbatch{2}.spm.tools.preproc8.tissue(6).tpm = tpm(6);
